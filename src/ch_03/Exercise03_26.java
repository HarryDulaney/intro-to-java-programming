...
public class Exercise03_26 {
    public static void main(String[] args) {
        ...
        System.out.println("Is 10 divisible by 5 and 6? " + fiveAndSix);
        System.out.println("Is 10 divisible by 5 or 6? " + fiveOrSix);
        System.out.println("Is 10 divisible by 5 or 6, but not both? " + fiveSixNotBoth);
