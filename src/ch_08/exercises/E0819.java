 ...
 * diagonally. public static boolean isConsecutiveFour(int[][] values)
 *Write a test program that prompts the user to enter the number of rows and columns of a
 * two-dimensional array and then the values in the array and displays
