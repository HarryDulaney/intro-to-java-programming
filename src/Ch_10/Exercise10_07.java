...
public class Exercise10_07 {
	...
	public static void executeCommand(int userCommand,int accId, 
		...
		case 1: System.out.println("The balance in account " + accId + " is " +
		arr[accId].getBalance()); break;
		
		case 2: System.out.print("Enter the amount you want to withdraw:");
					arr[accId].withdraw(j.nextDouble());break;
				
		case 3: System.out.print("Enter the amount you you want to deposit:");
